        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">Rincian</TableCell>
            ...
            <>
              {invoices.map((invoices) => (
                <TableRow style={rowStyle(invoices)} key={invoices.id}>
                  ...
                  <TableCell style={{ fontWeight: 'bold' }} align="center">{invoices.value.toLocaleString('id-ID', { style: 'currency', currency: 'IDR' })}</TableCell>
